...
public class InputListener  implements View.OnTouchListener{
    ...
    private boolean iconPressed(int sXNewGame, int sYIcons) {
        return isTap(1) && inRange(sXNewGame, x, sXNewGame + mView.iconSize)
                && inRange(sYIcons, y, sXNewGame + mView.iconSize);
    }
